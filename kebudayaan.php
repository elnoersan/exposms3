...
<body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#home">MACAM KEBUDAYAAN</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    $result = mysqli_query($conn, "SELECT b.*, k.nama_kategori FROM wisata b join kategori k on (b.id_kategori=k.id_kategori) WHERE k.id_kategori = 3 ORDER BY b.id_wisata DESC");
