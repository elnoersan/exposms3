                         ...
                         <div class="card">
                           ...
                           <div class="card-body">
                                  ...
                                  <form role="form" method="POST" action="proses_add_berita.php"enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-2 col-form-label"><label for="exampleInputJudul">Judul</label></div><div class="col-sm-10"> <input  required type="text" class="form-control" id="Judul" placeholder="Masukan Judul Berita" name="judul" ></div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                <div class="col-sm-2 col-form-label"><label for="exampleInputIsi">Isi</label></div><div class="col-sm-10"> <textarea required class="form-control" id="isi" placeholder="Masukan Isi Berita" name="isi"></textarea></div>
                                                </div>
                                                <div class="form-group row">
