          ...
          <div class="col-md-12">
                         <div class="card">
                           ...
                           <div class="card-body">
                             ...
                             <?php
                             $result = mysqli_query($conn, "SELECT b.*, k.nama_kategori FROM berita b join kategori k on (b.id_kategori=k.id_kategori) where b.id_berita = $_GET[id] ORDER BY b.id_berita DESC");
                             ...
                             ?>
                                  ...
                                  <form role="form" method="POST" action="proses_update_berita.php"enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-2 col-form-label"><label for="exampleInputJudul">Judul</label></div><div class="col-sm-10"> <input  required type="text" class="form-control" id="Judul" placeholder="Masukan Judul Berita" name="judul" value="<?php echo $rows['judul']; ?>"></div>
                                                </div>
