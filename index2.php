...
<html class="no-js"  lang="en">
	...
	<body>
							...
							<div class="main-menu">
								...
								<div class="collapse navbar-collapse">
									<ul class="nav navbar-nav navbar-right">
										...
										<li class="smooth-menu"><a href="#testemonial">testimoni</a></li>
		...
		<!-- testemonial Start -->
		<section id="testemonial"  class="testemonial">
			<div class="container">
								...
								<div class="col-sm-4 col-md-4">
									<div class="thumbnail">
										<h2>
											...
											<span><?php echo $row['tanggal'];?></span></h2>
										<div class="thumbnail-img">
											<img src="assets/images/blog/<?php echo $row['gambar'];?>" alt="blog-img">
